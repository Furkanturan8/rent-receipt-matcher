...
Version: 2.0
Dataset: data/synthetic_ocr_aware/ner_ocr_aware.json (2000 samples)
"""
...
class NERDataProcessor:
    ...
    def load_and_convert_data(self, json_path: str) -> List[Dict]:
        ...
        for idx, item in enumerate(data):
            try:
                # v2 dataset'te "combined_text" field'ı var
...
def main():
    ...
    # Paths (v2 - OCR Aware)
    data_path = "data/v2_ocr_aware/ner_ocr_aware.json"
    output_dir = "models/v2_ocr_aware/ner"
