"""
Intent Classification Model Training - V4 (Production Ready)
...
Version: 4.0
Dataset: data/v4_production/intent_v4.json (1000 samples)

v4 Yeni Özellikler:
- Multi-period support (kasım aralık ocak)
- Amount variations (24bin, 24bintl)
- Title variations (çalık-2, çalık2)
- Random order descriptions
"""
...
def main():
    ...
    print("=" * 60)
    print("🎯 Intent Classification Model Training - v4")
    print("=" * 60)
    
    # Paths (v4 - Production)
    data_path = "data/v4_production/intent_v4.json"
    output_dir = "models/v4_production/intent_classifier"
