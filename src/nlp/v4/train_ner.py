"""
Named Entity Recognition (NER) Model Training - V4 (Production Ready)
...
- PERIOD: Ödeme dönemi (multi-month: Kasım Aralık Ocak)
- APT_NO: Daire numarası (d2, daire:2, d:2)
- TITLE: Mülk adı (Çalık-2 Apart, çalık2) ⭐ NEW!

Version: 4.0 - PRODUCTION
Dataset: data/v4_production/ner_v4.json (3000 samples)
Features: Multi-period, Title entity, Amount variations, Random order
✅ FEE REMOVED - Unnecessary entity
✅ TITLE ADDED - Property name extraction
"""
...
# Entity label mapping (BIO format) - 11 entity types (v4)
ENTITY_LABELS = {
    "O": 0,
    # SENDER (Gönderen)
    "B-SENDER": 1,
    ...
    # PERIOD (Dönem) - Multi-month support
    "B-PERIOD": 17,
    "I-PERIOD": 18,
    # APT_NO (Daire no)
    "B-APT_NO": 19,
    "I-APT_NO": 20,
    # TITLE (Mülk adı) - NEW in v4!
    "B-TITLE": 21,
    "I-TITLE": 22,
}
...
class NERDataProcessor:
    ...
    def __init__(self):
        self.entity_types = [
            ...
            "TRANSACTION_TYPE", "PERIOD", "APT_NO", "TITLE"
        ]
...
class NERTrainer:
    ...
    def evaluate(self, test_dataset: Dataset, trainer: Trainer):
        ...
        results_data = {
            ...
            "entity_types": ["SENDER", "RECEIVER", "AMOUNT", "DATE", "SENDER_IBAN", "RECEIVER_IBAN", "BANK", "TRANSACTION_TYPE", "PERIOD", "APT_NO", "TITLE"]
        }
...
def main():
    ...
    print("="*80)
    print("🎯 NER Model Training - v4 (Production Ready)")
    print("="*80)
    print("\n📌 Entity Types (11):")
    print("   SENDER, RECEIVER, AMOUNT, DATE, SENDER_IBAN, RECEIVER_IBAN,")
    print("   BANK, TRANSACTION_TYPE, PERIOD, APT_NO, TITLE")
    print("\n✨ NEW: TITLE entity (mülk adı)")
    print("✅ REMOVED: FEE entity (gereksiz)")
    print()
    
    # Paths (v4 - Production)
    data_path = "data/v4_production/ner_v4.json"
    output_dir = "models/v4_production/ner"
